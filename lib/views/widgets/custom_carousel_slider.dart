                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('${item.author} • ${item.time}', style: const TextStyle(color: Colors.white),),
                          ),
                          Container(
                            decoration: BoxDecoration(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: _current == entry.key ? BorderRadius.circular(8.0) : null,
                    color: (Theme.of(context).brightness == Brightness.dark
                        ? Colors.white
                        : _current == entry.key ? Theme.of(context).primaryColor : Colors.black)
